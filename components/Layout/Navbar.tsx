  ...
  return (
    <div className="absolute top-0 w-full">
      <nav
        className={
          isOpen
            ? `dropdown-on  p-4 mdm:px-10 mdm:py-6 mdm:flex mdm:items-center bg-sky-600 ${bgColor}`
            : `dropdown-ff  p-4 mdm:px-10 mdm:py-6 mdm:flex mdm:items-center ${bgColor}`
        }
      >
        ...
        <div
          className={
            isOpen
              ? ' mdm:grow mdm:flex mdm:justify-between mdm:ml-6 mdm:h-11 on '
              : ' mdm:grow mdm:flex mdm:justify-between mdm:ml-6 mdm:h-11 off'
          }
        >
          ...
          <div className="md:flex md:items-center md:ml-auto">
            ...
            <button className="w-full my-8 mdm:my-0  md:px-6 text-white  py-2 rounded font-semibold bg-blue-900 md:w-auto md:transition md:duration-200 md:hover:bg-slate-200 md:hover:text-sky-600">
              Get Started
            </button>
          </div>
        </div>
