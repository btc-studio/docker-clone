...
export default function Footer() {
  return (
    <div className=" bg-blue2 text-white font-medium ">
      {/* <Image
        className="bg-blue1 cursor-pointer text-red-400"
        src={Logo}
        alt="logo"
        width={240}
        height={56}
      /> */}
      <div className="p-16 pb-10 pl-8">
        <svg
      ...
      <div className="w-full grid grid-cols-2 gap-7 p-3 last:place-items-end">
        <div>
          <ul>
            <li>Products</li>
            <ul>
      ...
      <div className="flex items-center flex-col p-9 ">
        <div className=" flex space-x-8 text-xl p-6">
          <FaFacebookF />
          <FaTwitter />
          <FaYoutube />
          <FaLinkedinIn />
        ...
        <ul className="text-sm flex space-x-3 p-6 items-center text-center">
          <li>Service</li>
          <li>Privacy</li>
          <li>Legal</li>
